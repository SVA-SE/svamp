...
```{r VetDistrictDist, warning=FALSE, message=FALSE, echo = FALSE, results='asis', eval=TRUE}
...
```{r Plot_Animal, results='asis',echo=FALSE, message=FALSE, warning=FALSE, fig.height= 4, fig.width=12}
...
The analysis covers the last __`r report_data_object()$days`__ days from the date of report generation (__`r Sys.Date()`__).
...
```{r PlotMissing, fig.width=12, fig.height=10, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center',fig.width=9.5, fig.height=7, results='asis', eval=intersec_km_test}
...
```{r  URAX_final, warning=FALSE, message=FALSE, echo = FALSE, results='asis', eval=TRUE}
...
if(nrow(urax_final) != 0) {
  ...
  urax_table <- urax_final[, c("Svalauppdragsid",
                               "Namn",
                               "Adress",
                               "Agens",
                               "Status",
  ...
  kable(urax_table, filter="top", row.names = FALSE)
